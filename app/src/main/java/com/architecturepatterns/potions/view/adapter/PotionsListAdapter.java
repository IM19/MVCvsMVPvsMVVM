...
public class PotionsListAdapter extends RecyclerView.Adapter<PotionsListAdapter.ViewHolder> {
    private List<Potion> mPotionsCollections;
    ...
    public PotionsListAdapter(List<Potion> list) {
        mPotionsCollections = list;
    }
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        Potion p = mPotionsCollections.get(position);
    ...
    public int getItemCount() {
        return mPotionsCollections.size();
    }
